...
def stats_per_chunk(chunk, block_data_totals):
	...
	# 	block_data_totals[block_id] += 1
	# total = 0
	# all_blocks = chunk.blocks.get_all_blocks()
	# for block_id in range(256):
	# 	id_count = all_blocks.count(block_id)
	# 	block_data_totals[block_id] += id_count
	# 	total += id_count
	# 	if total == 32768:
	# 		break
	# 	# print block_id, block_data_totals[block_id], total
